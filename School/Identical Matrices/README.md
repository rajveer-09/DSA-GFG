<h2><a href="https://practice.geeksforgeeks.org/problems/identical-matrices1042/1?page=1&category=Matrix&sortBy=difficulty">Identical Matrices</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two square matrices Grid1 and Grid2 with the same dimensions(NxN).Check whether they are identical or not.</span></p>
